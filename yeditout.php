...
if (isset($_POST['update'])) {
    ...
    $sql = "UPDATE fasilitastbl SET nama='$nama', pertanyaan1='$pertanyaan1', pertanyaan2='$pertanyaan2', pertanyaan3='$pertanyaan3', pertanyaan4='$pertanyaan4', pertanyaan5='$pertanyaan5' WHERE noidentitas='$noidentitas'";
...
$sql = "SELECT * FROM fasilitastbl WHERE noidentitas='$noidentitas'";
